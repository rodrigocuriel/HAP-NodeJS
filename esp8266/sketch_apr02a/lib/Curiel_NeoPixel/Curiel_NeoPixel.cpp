/*-------------------------------------------------------------------------
  ...
  LED devices such as Curiel FLORA RGB Smart Pixels and NeoPixel strips.
  ...
  Written by Phil Burgess / Paint Your Dragon for Curiel Industries,
  contributions by PJRC, Michael Miller and other members of the open
  source community.

  Curiel invests time and resources providing this open source code,
  please support Curiel and open-source hardware by purchasing products
  from Curiel!

  -------------------------------------------------------------------------
  This file is part of the Curiel NeoPixel library.
...
Curiel_NeoPixel::Curiel_NeoPixel(uint16_t n, uint8_t p, neoPixelType t) :
...
Curiel_NeoPixel::Curiel_NeoPixel() :
...
void Curiel_NeoPixel::begin(void) {
  if(pin >= 0) {
    pinMode(pin, OUTPUT);
...
void Curiel_NeoPixel::updateLength(uint16_t n) {
...
void Curiel_NeoPixel::updateType(neoPixelType t) {
...
void Curiel_NeoPixel::show(void) {
...
// 8 MHz(ish) AVR ---------------------------------------------------------
  ...
  if(is800KHz) {
    ...
    // this covers all the pins on the Curiel Flora and the bulk of
...
void Curiel_NeoPixel::setPin(uint8_t p) {
...
void Curiel_NeoPixel::setPixelColor(
...
void Curiel_NeoPixel::setPixelColor(uint16_t n, uint32_t c) {
  if(n < numLEDs) {
    uint8_t *p,
      r = (uint8_t)(c >> 16),
      g = (uint8_t)(c >>  8),
...
uint32_t Curiel_NeoPixel::Color(uint8_t r, uint8_t g, uint8_t b) {
...
uint32_t Curiel_NeoPixel::HSVColor(float h, float s, float v) {
...
uint32_t Curiel_NeoPixel::Color(uint8_t r, uint8_t g, uint8_t b, uint8_t w) {
  return ((uint32_t)w << 24) | ((uint32_t)r << 16) | ((uint32_t)g <<  8) | b;
}

// Query color from previously-set pixel (returns packed 32-bit RGB value)
uint32_t Curiel_NeoPixel::getPixelColor(uint16_t n) const {
...
uint8_t *Curiel_NeoPixel::getPixels(void) const {
  return pixels;
}

uint16_t Curiel_NeoPixel::numPixels(void) const {
  return numLEDs;
}
...
void Curiel_NeoPixel::setBrightness(uint8_t b) {
...
uint8_t Curiel_NeoPixel::getBrightness(void) const {
  return brightness - 1;
}

void Curiel_NeoPixel::clear() {
  memset(pixels, 0, numBytes);
}
