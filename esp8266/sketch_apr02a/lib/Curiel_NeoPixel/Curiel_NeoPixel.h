...
#ifndef CURIEL_NEOPIXEL_H
#define CURIEL_NEOPIXEL_H
...
// the same item.  The third parameter to the Curiel_NeoPixel
...
class Curiel_NeoPixel {

 public:

  // Constructor: number of LEDs, pin number, LED type
  Curiel_NeoPixel(uint16_t n, uint8_t p=6, neoPixelType t=NEO_GRB + NEO_KHZ800);
  Curiel_NeoPixel(void);
  ~Curiel_NeoPixel();
