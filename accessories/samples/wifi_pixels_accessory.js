...
var lightUUID = uuid.generate('hap-nodejs:accessories:wifipixelsmoodLight');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var light = exports.accessory = new Accessory('pixel light', lightUUID);
...
light
    .addService(Service.Lightbulb, "RGB Light") // services exposed to the user should have "names" like "Fake Light" for us
